        ...
        .then((response) => {
          ...
          router.push({
            ...
            params: {
              ...
              email: JSON.stringify(response.data.email).replace(/"/g, ""),
              admin: JSON.stringify(response.data.admin),
            },
          });
        })
        .catch((error) => {
    ...
    <ScrollView>
      <LinearGradient colors={["#09AFF7", "#E9E4F0"]} style={{ flex: 1 }}>
        <View style={{ padding: 12 }}>
          ...
          >
            <Text style={{ fontSize: 40, fontWeight: "600", padding: 20 }}>
              Welcome To BookMe 5656
            </Text>
          </View>

          <View
            style={{ alignItems: "center", marginBottom: 70, marginTop: 70 }}
          >
            <TextInput
              style={{
                width: "80%",
            ...
            >
              ...
              >
                ...
                >
                  ...
                  />
                  <Text
                    style={{ color: "white", fontSize: 18, paddingLeft: "15%" }}
                  >
                    Login
                  </Text>
                </View>
